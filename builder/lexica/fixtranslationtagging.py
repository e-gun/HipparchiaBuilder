...
# x = """<orth extent="full" lang="la" opt="n">laudo</orth>, <itype opt="n">āvi, ātum, 1</itype>, <pos opt="n">v. a.</pos> <etym opt="n">laus</etym>, <sense id="n26064.0" n="I" level="1" opt="n"><hi rend="ital">to praise, laud, commend, extol, eulogize, approve</hi> (cf.: celebro, praed co). </sense><sense id="n26064.1" n="I" level="1" opt="n"> <usg type="style" opt="n">Lit.</usg> </sense><sense id="n26064.2" n="A" level="2" opt="n"> In gen.: omnes mortales sese laudarier optant, Enn. ap. <bibl n="Perseus:abo:phi,2468,001:Trin. 13:6" default="NO"><author>Aug.</author> Trin. 13, 6</bibl> (Ann. v. 551 Vahl.): <cit><quote lang="la">coram in os te laudare,</quote> <trans opt="n"><tr opt="n">to praise to one's face</tr>,</trans> <bibl n="Perseus:abo:phi,0134,006:269" rewritten="yes" default="NO" valid="yes"><author>Ter.</author> Ad. 269</bibl></cit>"""
# print(latintranslationtagrepairs(x))